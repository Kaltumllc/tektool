...
// senior uses junior_id column since they submitted it themselves
$result = mysqli_query($conn, "
    SELECT hr.id, hr.title, hr.description, hr.status, hr.created_at,
                ...
                <div class="request-item request-item-full">
                    <div class="request-info">
                        ...
                        <span class="request-meta">
                            <?= $req['assigned_name']
                                ? '👷 Assigned to ' . htmlspecialchars($req['assigned_name'])
                                : '⏳ Awaiting assignment' ?>
                            &nbsp;·&nbsp;
